    ...
    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
        ...
        if a == True:
            ...
            if text == 'информация о курсах':
                ...
                '\n\nЕсли у тебя остались вопросы, не стесняйся их задавать здесь нашим менеджерам!', '1.png', keyboard1)

                send_message(user_id, 'Также обрати внимание на скрин с тарифами, которые можно выбрать при покупке курса:', '2.png', keyboard1)
                ...
                '\n\nЕсли у тебя остались вопросы, не стесняйся их задавать здесь нашим менеджерам!', "1.pdf", keyboard1)
